...
{
    public class ForCSharp : IEnumerable<object[]>
    {
        private const string FileName = "CSharpForClass.CSharp";
    ...
    public class ForVisualBasic : IEnumerable<object[]>
    {
        private const string FileName = "VisualBasicForClass.VisualBasic";
